      ...
      <div class="container" v-loading="loading">
        ...
        <div class="flex justify-between">
          <div style="width: 200px; position: relative; top: 10px">
            <el-tree :data="treeData" :props="defaultProps" default-expand-all style="background:none; color: #fff"></el-tree>
          </div>
          <div>
          <div class="equipment" v-if="monitorList.length > 0" style="width: 400px">
