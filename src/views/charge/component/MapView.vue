    ...
    <div class="macl-outbox overflow-hidden">
      ...
      <div class="macl-map-view">
        <div class="macl-box">
          <ul>
            <li
              v-for="(item, index) in mapBoxList"
              :key="index"
            ...
            >
              ...
              <div>
                ...
                <footer class="data">{{ item.data }}</footer>
              </div>
            </li>
          </ul>
        </div>
      ...
      <div class="bottom-box flex justify-between items-center">
...
import pic1 from "@/assets/images/chargeManage/average-daily-income.png";
import pic2 from "@/assets/images/chargeManage/traffic-flow.png";
import pic3 from "@/assets/images/chargeManage/kilometer-income.png";
const mapBoxList: Array<Object> = [
  {
    icon: pic1,
    title: "日均收入",
    unit: "（万元）",
...
const bottomList: any = [
  { data: 1914354, describe: "当前通行费" },
  { data: 57, describe: "当日特情车辆数" },
  { data: 32014520, describe: "年度ETC通行量" },
  { data: 9310416, describe: "年度货车通行量" },
  { data: 48671792, describe: "年度通行量" },
];
