<template>
  <div class="malc-box">
    <div class="mdhead">管理里程(km)</div>
    <div v-for="(item, index) in dataList" :key="index" class="mdlc-cont">
      <div class="malc-tit">{{ item.name }}</div>
      <div class="malc-line">
        <div class="malc-left" :class="index > 1 ? 'malc-left2' : ''"></div>
        <div class="malc-center" :class="index > 1 ? 'malc-center2' : ''">
          <div
            class="malc-center-in"
            :class="index > 1 ? 'malc-center-in2' : ''"
          ></div>
        </div>
        <div class="macl-rig">{{ item.value }}</div>
      </div>
    </div>
  </div>
</template>
